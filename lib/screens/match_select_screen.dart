// lib/screens/match_select_screen.dart - MATCH MADNESS SELECTION
import 'dart:math';
                    ...
                    Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Match the Psychedelic Tarot Cards',
                          ...
                          Column(
                            children: [
                              _PsychedelicModeButton(
                                label: 'Practice Mode',
                                description: 'Train your matching skills',
                                isPractice: true,
                              ...
                              _PsychedelicModeButton(
                                ...
                                description: '64 players, fastest time wins',
                                isPractice: false,
                                animationController: _ctrl,
                                colors: interpolatedColors,
                                onTap: () {
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  '• Cards reveal for 3 seconds, memorize them\n'
                                      '• Match all 8 pairs as fast as possible\n'
                                      '• Wrong matches give -1 second penalty\n'
                                      '• Fastest time advances to next round\n'
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (_) => MatchGameScreen(
                  ...
                  tourneyId: widget.isPractice ? 'match_practice' : 'match_tournament',
                ),
              ),
            );
          },
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  child: Icon(
                    widget.isPractice ? Icons.style : Icons.emoji_events,
                    size: 24,
                    color: Colors.white,
                  ),
                ),
